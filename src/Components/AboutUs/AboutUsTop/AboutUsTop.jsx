            ...
            <div className="container mx-auto p-4">
                ...
                <div className='flex flex-wrap gap-[30px] mb-[30px]'>
                    <div className='max-w-[500px] p-[30px] bg-invertedTextColor rounded-elementRounded shadow-xl transition-all hover:scale-[1.02]'>
                        <h4 className="text-3xl font-extrabold mb-[30px]">— Почему выбирают нас?</h4>
                    ...
                    <div className='flex flex-col gap-[30px]'>
                        <div className='max-w-[500px] p-[30px] bg-invertedTextColor rounded-elementRounded shadow-xl transition-all hover:scale-[1.02]'>
                            <h4 className="text-3xl font-extrabold mb-[30px]">— Наша команда</h4>
                            <p>
                        ...
                        <div className='max-w-[500px] p-[30px] bg-invertedTextColor rounded-elementRounded shadow-xl transition-all hover:scale-[1.02]'>
                            <h4 className="text-3xl font-extrabold mb-[30px]">— Как работает сайт?</h4>
                            <ul className="flex flex-col gap-[15px]">
                                <li>
                    ...
                    <div className='max-w-[500px] p-[30px] bg-invertedTextColor rounded-elementRounded shadow-xl transition-all hover:scale-[1.02]'>
                        <h4 className="text-3xl font-extrabold mb-[30px]">— В ближайшем будущем: Физическая точка обслуживания</h4>
                        <p>
