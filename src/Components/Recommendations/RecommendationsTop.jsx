        ...
        <section>
            <div className="container">
                ...
                <div className="photoDoc-recommendations">
                    <div className='flex justify-center gap-[50px] items-center mb-[20px] w-1290:flex-wrap'>
                        <div className='flex flex-col gap-[10px]'>
                            {
                                photoDocRecommendationsData.map((item, index) => (
                                    <RecommendationCard key={index} cardData={item} index={index}/>
                                ))
                            }
                        </div>
                    ...
                    <div className='max-w-[1050px] mx-auto text-center p-[20px] text-2xl font-extrabold text-textColor rounded-elementRounded'>
                        <p className='mb-[10px] w-460:text-xl'>Убедитесь, что ваша фотография подходит под пункты рекомендаций. <br /> Если не соблюдать рекомендации, фотографии могут быть забракованы!</p>
                        <p className='w-460:text-xl'>В случае отправки фотографий не попадающих под пункты рекомендаций вы получите смс на указанную вами почту или мессенджеры о том, что нарушены условия отправки фотографий. Заказ будет отменен, a средства возвращены.</p>
                    </div>
