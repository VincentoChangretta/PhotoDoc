...
export const OrderByCode = ({ setOrderByCode }) => {
    ...
    return (
        <div className='fixed z-[2000] inset-0 flex justify-center items-center backdrop-blur'>
            <div ref={modalRef} className='relative max-w-[600px] w-full p-[30px] rounded-elementRounded bg-textColor text-invertedTextColor text-center shadow-cardShadow w-560:pr-[60px]'>
                ...
                <div className='flex flex-col items-center gap-[20px]'>
                    ...
                    <div className='max-w-[350px] w-full'>
                        ...
                        <Input getValue={setCodeValue} className="max-w-[350px] w-full" placeholder="07.05.24 - Давид" />
                    </div>
