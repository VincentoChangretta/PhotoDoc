...
export const faqData = [
  ...
  {
    id: "faq2",
    question: "Как мне отправить фото для обработки?",
    answer:
      "Вы можете загрузить ваше фото в нашу систему на сайте или отправить его через мессенджеры (например, WhatsApp, Telegram) или на нашу электронную почту.",
  },
  {
    id: "faq12",
    question: "Как подготовить фото для отправки?",
    answer:
      "Сфотографируйтесь на нейтральном фоне (предпочтительно белом), убедитесь, что лицо освещено равномерно, и избегайте теней. Если у вас есть сомнения, отправьте нам фото, и мы проверим его перед обработкой.",
  },
  {
    id: "faq3",
  ...
  },
  {
    ...
    answer:
      "Электронные фотографии мы отправляем в течение 1–2 часов после оплаты. Бумажные фотографии доставляются курьером в течение 1–2 рабочих дней, в зависимости от вашего местоположения.",
  },
  {
    id: "faq6",
  ...
  },
  {
    ...
    answer:
      "Оплата принимается онлайн через банковскую карту, электронные кошельки или переводы в популярных мессенджерах. Подробности будут указаны при оформлении заказа.",
  },
  {
    id: "faq9",
    question: "Что делать, если у меня нет подходящей фотографии?",
    answer:
      "Если у вас нет подходящего фото, вы можете сделать снимок на телефон с учетом наших рекомендаций. Мы поможем скорректировать фото для соответствия требованиям документа.",
  },
  {
    id: "faq11",
